...
export default function AuthorDetail() {
  ...
  // Convert the topic_profile array into data for a radar chart.
  const prepareExpertiseData = (profile: number[]) => {
    ...
    return profile
      ...
      .filter((item) => item.originalProb > 0.02) // Focus only on areas where you are more than 2% an expert.
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
            ...
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-3 mb-2">
                ...
                {author.primary_cluster && (
                  <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
                    Expertise: Topic {author.primary_cluster}
                  </span>
                )}
              </div>
