...
from api.services.skill_embedding_builder import build_and_save_skill_embeddings_dedup
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--threshold", type=float, default=0.9, help="Cosine similarity threshold for merging")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.NOTICE(f"เริ่มสร้าง embeddings จาก {csv_path} (threshold={threshold})"))
