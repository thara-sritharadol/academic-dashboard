...
class Command(BaseCommand):
    help = "Find optimal K for LDA using Perplexity and Topic Coherence with Spacy Preprocessing."
    ...
    def handle(self, *args, **options):
        ...
        ax1.plot(k_values, perplexity_scores, marker='x', color=color, linestyle='--', linewidth=2, label='Perplexity')
        ...
        filename = "lda_optimal_k_selection.png"
